...
> ## ➡️ CURRENT visual direction: **DESIGN v3 "Notion × LinkedIn × Reddit"** — see `.docs/design/UI-ENRICHMENT.md`.
> v3 builds on the v2 Calm-Paper base below (adds canvas depth, richer cards, LinkedIn structure, Reddit engagement affordances). Read UI-ENRICHMENT.md first for what's live + the per-surface roadmap; this file remains the token/foundation reference.

> ## ⚠️ v2 — "Calm Paper" (Notion-style) base system. v3 (above) supersedes its flat-card treatment.
>
